		...
		<div class="page-header-inner">
			...
			<div class="page-logo">
				<a href="/healthcare" id=""> <img src="img/change_logo_1.png"
					...
					style="color: #FFF; font-size: 20px; font-weight: bold; font-family: SimHei;">中国心脑血管病大数据共享平台</span>
			...
			<div class="hor-menu hor-menu-light hidden-sm hidden-xs">
				<ul class="nav navbar-nav">
					<li class="classic-menu-dropdown" style="height: 60px;"><a
						style="color: #c6cfda;" href="userdatabaseview">元数据 </a></li>
					<li class="classic-menu-dropdown"><a style="color: #c6cfda;"
						href="topicanalysis" target="_blank"> 主题分析 </a></li>
					<li class="classic-menu-dropdown"><a style="color: #c6cfda;"
						href="applydata/applytable" target="_blank"> 数据服务 </a></li>
					<li class="classic-menu-dropdown"><a style="color: #c6cfda;"
						href="applyenv/applytable" target="_blank"> 虚拟计算 </a></li>
				</ul>
			</div>
			<!-- END HORIZANTAL MENU -->
					...
					<li class="dropdown dropdown-user"><a href="javascript:;"
						...
						<ul class="dropdown-menu dropdown-menu-default">
							...
							<li><a href="applyenv/applytable"> <i
									class="icon-rocket"></i> 虚拟计算<span class="badge badge-success">
										7 </span>
							</a></li>
							<li class="divider"></li>
	...
	<div class="page-container">
			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu hidden-sm hidden-xs"
					...
					<li class="open"><a href="javascript:;"> <i
							class="icon-folder"></i> <span class="title">参与机构分布</span> <span
							class="arrow open"></span>
					</a>
						<ul class="sub-menu" style="display: block;">
							<li><a href="javascript:;" id="joinhospital"> <i class="icon-folder"></i>
									<span class="title">参与基地医院</span> 
							</a></li>
							<li><a href="javascript:;" id="joincommunity"> <i class="icon-folder"></i>
									<span class="title">参与社区卫生医疗机构</span> 
							</a></li>
						</ul>
					</li>

					<li><a href="javascript:;"  id="crowdfeature"> <i
							class="icon-folder"></i> <span class="title">人群特征</span>
					</a>
					</li>
					<li><a href="javascript:;" > <i
							class="icon-folder"></i> <span class="title">疾病负担</span> <span
							class="arrow"></span>
					</a>
						<ul class="sub-menu">
							<li><a href="javascript:;"  id="diseaseburden_map"> <i class="icon-folder"></i>
									<span class="title">地图展示</span> 
							</a></li>
							<li><a href="javascript:;"  id="diseaseburden_picture"> <i class="icon-folder"></i>
									<span class="title">图表展示</span> 
							</a></li>
						</ul>
					</li>
					<li><a href="javascript:;"  id="dangerfactor"> <i
							class="icon-folder"></i> <span class="title">危险因素</span>
					</a>
					</li>
				</ul>
			</div>
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				<iframe id="main" src="hospital_distribution_base"
					scrolling="auto" height="1000px" width="99%" frameborder="0"
					align="top"></iframe>
			</div>
		</div>
		<!-- END CONTENT -->
...
<![endif]-->
	...
	<script src="resources/js/topicanalysis/topicanalysis_screen.js"
		type="text/javascript"></script>
	<script>
