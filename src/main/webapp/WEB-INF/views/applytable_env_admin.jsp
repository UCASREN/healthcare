							...
							<div class="table-container">
								...
								<table class="table table-striped table-bordered table-hover" id="datatable_products">
									...
									<tr role="row" class="filter" id="filter_panel">
										...
										<td>
											<input type="text" class="form-control form-filter input-sm" name="applyData_userDepartment">
										</td>
										<td>
...
<script src="../resources/js/apply/applyEnvtable_admin.js"></script>
