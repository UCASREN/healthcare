...
// Generated 2015-12-29 16:34:06 by Hibernate Tools 4.0.0

/**
 * HcApplyenv generated by hbm2java
 */
@Entity
public class HcApplyenv implements java.io.Serializable {
	...
	public HcApplyenv(String hcUsername, String docName) {
		this.hcUsername = hcUsername;
		this.docName = docName;
	}

	public HcApplyenv(String hcUsername, String docName, String name, String department, String address, String tel,
			...
			String applyRejectReason, String envUrl, String applyData, String applyDataExportType) {
		this.hcUsername = hcUsername;
		this.docName = docName;
		this.name = name;
